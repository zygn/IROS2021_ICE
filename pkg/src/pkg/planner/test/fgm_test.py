import numpy as np
import math
from .speed_test import SpeedController as SC1
from .speed_test_2 import SpeedController as SC2 
...
class FGM_p:
    def __init__(self, params=None):
        ...
        self.ovt = False
        self.ovt_flag = False
        self.ovt_debug = False

        self.speed_controllers = [SC1(params), SC2(params)]
